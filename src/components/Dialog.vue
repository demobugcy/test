    ...
    <el-dialog
        ...
        <el-form :model="form" size="small" label-width="80px"  >
            ...
            <el-form-item label="商品图片">
                <el-image :src="url" fit="scale-down" lazy style="margin: 20px auto;">
                </el-image>
            </el-form-item>
            <!--:action="action"-->
            <el-upload
...
export default {
    ...
    computed:{
        ...
        url:{
            get(){
                if(this.aurl==null){
                    return this.HOST+this.form.photoOne
                }
                return this.aurl
            },
            set (newValue) {
                // this.aurl=this.HOST+newValue
                this.form.photoOne=newValue
            }
        },
    },
    data(){
    ...
    methods:{  
        ...
        uploadSuccess(response,fileList, row) {
            ...
            this.form.photoOne=response.data;
        },
